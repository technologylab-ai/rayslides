...
pub const InheritedPropertyOverrides = packed struct(u32) {
    ...
    focus_x: bool = false,
    focus_y: bool = false,
    video_size: bool = false,
    cam_format: bool = false,
    poster_image: bool = false,
    poster: bool = false,
    volume: bool = false,
    autoplay: bool = false,
    loop: bool = false,
...
fn setPropertyOverride(overrides: *InheritedPropertyOverrides, property: InheritedProperty) void {
    switch (property) {
        ...
        .video_size => overrides.video_size = true,
        .cam_format => overrides.cam_format = true,
        .poster_image => overrides.poster_image = true,
