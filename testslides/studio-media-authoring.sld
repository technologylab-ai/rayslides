...
@push qa_video vid=assets/video_demo.mp4 w=760 h=360 fit=contain focus_y=0.5 poster=0.5 volume=0.8
...
@pop qa_video id=hero_video vid=assets/video_demo.mp4 x=1064 y=240 fit=cover focus_y=0.75 poster=1 volume=0.65 loop muted
@box id=video_note x=1064 y=704 w=760 h=150 fontsize=30 color=#a9bdd0ff
Poster at 1s · loop enabled
