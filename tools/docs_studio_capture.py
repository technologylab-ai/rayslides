...
CAPTURES: tuple[Capture, ...] = (
    ...
    Capture("new-deck", 1920, 1080, None),
)
...
def main() -> None:
    ...
    for capture in selected_captures(args.scenario):
        run_capture(capture, binary, args.output.resolve(), args.workspace, args.timeout)
